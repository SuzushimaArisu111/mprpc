...
static void InitDefaultsscc_info_GetFriendListRequest_friend_2eproto() {
  ...
  {
    void* ptr = &::acid::_GetFriendListRequest_default_instance_;
    new (ptr) ::acid::GetFriendListRequest();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::acid::GetFriendListRequest::InitAsDefaultInstance();
}
...
static void InitDefaultsscc_info_GetFriendListResponse_friend_2eproto() {
  ...
  {
    void* ptr = &::acid::_GetFriendListResponse_default_instance_;
    new (ptr) ::acid::GetFriendListResponse();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::acid::GetFriendListResponse::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_friend_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::acid::GetFriendListRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::acid::GetFriendListRequest, userid_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::acid::GetFriendListResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::acid::GetFriendListResponse, result_),
  PROTOBUF_FIELD_OFFSET(::acid::GetFriendListResponse, friends_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::acid::ResultCode)},
  { 7, -1, sizeof(::acid::GetFriendListRequest)},
  { 13, -1, sizeof(::acid::GetFriendListResponse)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::acid::_ResultCode_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::acid::_GetFriendListRequest_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::acid::_GetFriendListResponse_default_instance_),
};

const char descriptor_table_protodef_friend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014friend.proto\022\004acid\"-\n\nResultCode\022\017\n\007er"
  "rcode\030\001 \001(\005\022\016\n\006errmsg\030\002 \001(\014\"&\n\024GetFriend"
  "ListRequest\022\016\n\006userid\030\001 \001(\r\"J\n\025GetFriend"
  "ListResponse\022 \n\006result\030\001 \001(\0132\020.acid.Resu"
  "ltCode\022\017\n\007friends\030\002 \003(\0142\\\n\020FriendService"
  "Rpc\022H\n\rGetFriendList\022\032.acid.GetFriendLis"
  "tRequest\032\033.acid.GetFriendListResponseB\003\200"
  "\001\001b\006proto3"
  ;
...
GetFriendListRequest::GetFriendListRequest()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:acid.GetFriendListRequest)
}
GetFriendListRequest::GetFriendListRequest(const GetFriendListRequest& from)
  ...
  // @@protoc_insertion_point(copy_constructor:acid.GetFriendListRequest)
}
...
GetFriendListRequest::~GetFriendListRequest() {
  // @@protoc_insertion_point(destructor:acid.GetFriendListRequest)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:acid.GetFriendListRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendListRequest::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:acid.GetFriendListRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:acid.GetFriendListRequest)
  return target;
}

size_t GetFriendListRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:acid.GetFriendListRequest)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:acid.GetFriendListRequest)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFriendListRequest* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFriendListRequest>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:acid.GetFriendListRequest)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:acid.GetFriendListRequest)
    MergeFrom(*source);
  }
}

void GetFriendListRequest::MergeFrom(const GetFriendListRequest& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:acid.GetFriendListRequest)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:acid.GetFriendListRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:acid.GetFriendListRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void GetFriendListResponse::InitAsDefaultInstance() {
  ::acid::_GetFriendListResponse_default_instance_._instance.get_mutable()->result_ = const_cast< ::acid::ResultCode*>(
      ::acid::ResultCode::internal_default_instance());
}
class GetFriendListResponse::_Internal {
 public:
  static const ::acid::ResultCode& result(const GetFriendListResponse* msg);
};
...
GetFriendListResponse::GetFriendListResponse()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:acid.GetFriendListResponse)
}
GetFriendListResponse::GetFriendListResponse(const GetFriendListResponse& from)
  ...
  // @@protoc_insertion_point(copy_constructor:acid.GetFriendListResponse)
}
...
GetFriendListResponse::~GetFriendListResponse() {
  // @@protoc_insertion_point(destructor:acid.GetFriendListResponse)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:acid.GetFriendListResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendListResponse::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:acid.GetFriendListResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:acid.GetFriendListResponse)
  return target;
}

size_t GetFriendListResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:acid.GetFriendListResponse)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:acid.GetFriendListResponse)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFriendListResponse* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFriendListResponse>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:acid.GetFriendListResponse)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:acid.GetFriendListResponse)
    MergeFrom(*source);
  }
}

void GetFriendListResponse::MergeFrom(const GetFriendListResponse& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:acid.GetFriendListResponse)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:acid.GetFriendListResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:acid.GetFriendListResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void FriendServiceRpc::GetFriendList(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::acid::GetFriendListRequest*,
                         ::acid::GetFriendListResponse*,
  ...
  switch(method->index()) {
    case 0:
      GetFriendList(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::acid::GetFriendListRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::acid::GetFriendListResponse*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& FriendServiceRpc::GetRequestPrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::acid::GetFriendListRequest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
const ::PROTOBUF_NAMESPACE_ID::Message& FriendServiceRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::acid::GetFriendListResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
template<> PROTOBUF_NOINLINE ::acid::GetFriendListRequest* Arena::CreateMaybeMessage< ::acid::GetFriendListRequest >(Arena* arena) {
  return Arena::CreateInternal< ::acid::GetFriendListRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::acid::GetFriendListResponse* Arena::CreateMaybeMessage< ::acid::GetFriendListResponse >(Arena* arena) {
  return Arena::CreateInternal< ::acid::GetFriendListResponse >(arena);
}
