...
template<> ::acid::RegRequest* Arena::CreateMaybeMessage<::acid::RegRequest>(Arena*);
template<> ::acid::Response* Arena::CreateMaybeMessage<::acid::Response>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace acid {
...
class RegRequest :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:acid.RegRequest) */ {
 public:
  RegRequest();
  virtual ~RegRequest();
  ...
  void clear_sex();
  ::acid::RegRequest_SEX sex() const;
  void set_sex(::acid::RegRequest_SEX value);
  private:
  ::acid::RegRequest_SEX _internal_sex() const;
  void _internal_set_sex(::acid::RegRequest_SEX value);
  public:

  // @@protoc_insertion_point(class_scope:acid.RegRequest)
 private:
  class _Internal;
...
class Response :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:acid.Response) */ {
 public:
  Response();
  virtual ~Response();
  ...
  // @@protoc_insertion_point(class_scope:acid.Response)
 private:
  class _Internal;
...
inline const std::string& RegRequest::name() const {
  // @@protoc_insertion_point(field_get:acid.RegRequest.name)
  return _internal_name();
}
inline void RegRequest::set_name(const std::string& value) {
  _internal_set_name(value);
  // @@protoc_insertion_point(field_set:acid.RegRequest.name)
}
inline std::string* RegRequest::mutable_name() {
  // @@protoc_insertion_point(field_mutable:acid.RegRequest.name)
  return _internal_mutable_name();
}
...
inline void RegRequest::set_name(std::string&& value) {
  ...
  name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:acid.RegRequest.name)
}
inline void RegRequest::set_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:acid.RegRequest.name)
}
inline void RegRequest::set_name(const char* value, size_t size) {
  
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:acid.RegRequest.name)
}
...
inline std::string* RegRequest::release_name() {
  // @@protoc_insertion_point(field_release:acid.RegRequest.name)
...
inline void RegRequest::set_allocated_name(std::string* name) {
  ...
  name_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name);
  // @@protoc_insertion_point(field_set_allocated:acid.RegRequest.name)
}
...
inline const std::string& RegRequest::pwd() const {
  // @@protoc_insertion_point(field_get:acid.RegRequest.pwd)
  return _internal_pwd();
}
inline void RegRequest::set_pwd(const std::string& value) {
  _internal_set_pwd(value);
  // @@protoc_insertion_point(field_set:acid.RegRequest.pwd)
}
inline std::string* RegRequest::mutable_pwd() {
  // @@protoc_insertion_point(field_mutable:acid.RegRequest.pwd)
  return _internal_mutable_pwd();
}
...
inline void RegRequest::set_pwd(std::string&& value) {
  ...
  pwd_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:acid.RegRequest.pwd)
}
inline void RegRequest::set_pwd(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:acid.RegRequest.pwd)
}
inline void RegRequest::set_pwd(const char* value, size_t size) {
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:acid.RegRequest.pwd)
}
...
inline std::string* RegRequest::release_pwd() {
  // @@protoc_insertion_point(field_release:acid.RegRequest.pwd)
...
inline void RegRequest::set_allocated_pwd(std::string* pwd) {
  ...
  pwd_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), pwd);
  // @@protoc_insertion_point(field_set_allocated:acid.RegRequest.pwd)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 RegRequest::age() const {
  // @@protoc_insertion_point(field_get:acid.RegRequest.age)
...
inline void RegRequest::set_age(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:acid.RegRequest.age)
}
...
inline ::acid::RegRequest_SEX RegRequest::_internal_sex() const {
  return static_cast< ::acid::RegRequest_SEX >(sex_);
}
inline ::acid::RegRequest_SEX RegRequest::sex() const {
  // @@protoc_insertion_point(field_get:acid.RegRequest.sex)
  return _internal_sex();
}
inline void RegRequest::_internal_set_sex(::acid::RegRequest_SEX value) {
  
  sex_ = value;
}
inline void RegRequest::set_sex(::acid::RegRequest_SEX value) {
  _internal_set_sex(value);
  // @@protoc_insertion_point(field_set:acid.RegRequest.sex)
}
...
inline const std::string& RegRequest::phone() const {
  // @@protoc_insertion_point(field_get:acid.RegRequest.phone)
  return _internal_phone();
}
inline void RegRequest::set_phone(const std::string& value) {
  _internal_set_phone(value);
  // @@protoc_insertion_point(field_set:acid.RegRequest.phone)
}
inline std::string* RegRequest::mutable_phone() {
  // @@protoc_insertion_point(field_mutable:acid.RegRequest.phone)
...
inline void RegRequest::set_phone(std::string&& value) {
  ...
  phone_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:acid.RegRequest.phone)
}
inline void RegRequest::set_phone(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:acid.RegRequest.phone)
}
inline void RegRequest::set_phone(const char* value, size_t size) {
  ...
  phone_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:acid.RegRequest.phone)
}
...
inline std::string* RegRequest::release_phone() {
  // @@protoc_insertion_point(field_release:acid.RegRequest.phone)
...
inline void RegRequest::set_allocated_phone(std::string* phone) {
  ...
  // @@protoc_insertion_point(field_set_allocated:acid.RegRequest.phone)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Response::errorno() const {
  // @@protoc_insertion_point(field_get:acid.Response.errorno)
...
inline void Response::set_errorno(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:acid.Response.errorno)
}
...
inline const std::string& Response::errormsg() const {
  // @@protoc_insertion_point(field_get:acid.Response.errormsg)
  return _internal_errormsg();
}
inline void Response::set_errormsg(const std::string& value) {
  _internal_set_errormsg(value);
  // @@protoc_insertion_point(field_set:acid.Response.errormsg)
}
inline std::string* Response::mutable_errormsg() {
  // @@protoc_insertion_point(field_mutable:acid.Response.errormsg)
...
inline void Response::set_errormsg(std::string&& value) {
  ...
  errormsg_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:acid.Response.errormsg)
}
inline void Response::set_errormsg(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:acid.Response.errormsg)
}
inline void Response::set_errormsg(const char* value, size_t size) {
  ...
  errormsg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:acid.Response.errormsg)
}
...
inline std::string* Response::release_errormsg() {
  // @@protoc_insertion_point(field_release:acid.Response.errormsg)
...
inline void Response::set_allocated_errormsg(std::string* errormsg) {
  ...
  // @@protoc_insertion_point(field_set_allocated:acid.Response.errormsg)
}
...
inline bool Response::result() const {
  // @@protoc_insertion_point(field_get:acid.Response.result)
...
inline void Response::set_result(bool value) {
  ...
  // @@protoc_insertion_point(field_set:acid.Response.result)
}
...
template <> struct is_proto_enum< ::acid::RegRequest_SEX> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::acid::RegRequest_SEX>() {
  return ::acid::RegRequest_SEX_descriptor();
}
